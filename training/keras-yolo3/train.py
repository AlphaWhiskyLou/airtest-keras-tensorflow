...
def train(model, annotation_path, input_shape, anchors, num_classes, log_dir='logs/'):
    ...
    checkpoint = ModelCheckpoint(log_dir + "ep{epoch:03d}-loss{loss:.3f}-val_loss{val_loss:.3f}.h5",
                                 monitor='val_loss', mode='min', verbose=1, save_best_only=True, save_weights_only=True, period=1)

    callback_lists = [logging, checkpoint]
    batch_size =8
    val_split = 0.2
    ...
    model.load_weights('model_data/logs/ep054-loss55.085-val_loss58.711.h5')
